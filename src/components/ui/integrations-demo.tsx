    ...
    >
      <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-10">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref} className="size-12 border-gray-300">
            <Icons.googleDrive />
          </Circle>
          <Circle ref={div5Ref} className="size-12 border-gray-300">
            <Icons.googleDocs />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref} className="size-12 border-gray-300">
            <Icons.notion />
          </Circle>
          <Circle ref={div4Ref} className="size-16 border-gray-400">
            <Icons.openai />
          </Circle>
          <Circle ref={div6Ref} className="size-12 border-gray-300">
            <Icons.zapier />
          </Circle>
        </div>
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div3Ref} className="size-12 border-gray-300">
            <Icons.whatsapp />
          </Circle>
          <Circle ref={div7Ref} className="size-12 border-gray-300">
            <Icons.messenger />
          </Circle>
        </div>
      </div>
